...
A VS Code extension that lets you play classic casino games right in your editor. For entertainment purposes only — no real money involved.
...
2. Click the casino icon in the Activity Bar to open the sidebar, or run the command **Vegas Casino Games: Open Vegas Casino Games** from the Command Palette (`Ctrl+Shift+P`).
...
Open VS Code Settings and search for "Vegas Casino Games" to configure:
...
| Theme | Classic | Classic Casino, Neon Vegas, or Dark Luxury |
